...
aliases: [alkaloids, berberine, thymoquinone]
---
...
## Berberine
**Source:** Barberry root (Berberis vulgaris), goldenseal, Oregon grape root
**logP:** ~0.7–1.2 (moderate polarity, reasonable brine extraction)
...
## Thymoquinone
**Source:** Nigella sativa (black seeds)
**logP:** ~1.9 (moderately lipophilic, partial brine extraction — seeds should be consumed directly)
...
**logP:** ~0.4 (somewhat water-soluble, reasonable brine extraction)
...
**Mechanism:** STAT6 inhibition → IgE class switching suppression; Beclin-1 autophagy induction; HMGB1 danger signal pathway modulation
