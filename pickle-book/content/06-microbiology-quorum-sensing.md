...
description: "tags: [microbiology, quorum-sensing, AI-2, indole, AhR, biofilm]"
author: "Nick James"
tags: ["microbiology", "fatprotocol"]
---
...
**The SAM/methylation connection:**
LuxS doesn't have a dedicated biosynthetic pathway. It is a side reaction of bacterial one-carbon metabolism — specifically cleaving S-ribosylhomocysteine (a breakdown product of SAH, S-adenosylhomocysteine). SAH is generated every time SAM donates a methyl group, in bacteria exactly as in host cells. Bacteria recycle SAH back to homocysteine and methionine through their own activated methyl cycle, and AI-2 production is a direct byproduct.
...
1. Bacterial indole derivatives (microbiome output)
2. DIM from cruciferous vegetable glucosinolates (dietary input)
